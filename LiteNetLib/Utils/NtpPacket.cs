...
namespace LiteNetLib.Utils
{
    ...
    public class NtpPacket
    {
        ...
        /// 获取闰秒指示符（leap second indicator） ，表示服务器是否发出闰秒警告
        /// </summary>
        /// <value>
        ...
        /// 获取或设置 SNTP 协议版本号，默认值为 4，代表最新的 SNTP 版本
        /// </summary>
        /// <value>
        ...
        /// 获取或设置 SNTP 包模式，决定该包是客户端请求还是服务器响应。默认模式为客户端
        /// </summary>
        /// <value>
        ...
        /// 获取服务器距离参考时钟的距离（stratum）。值越小，离参考时钟越近
        /// </summary>
        /// <value>
        /// <para>
        ...
        /// 获取服务器使用的时间源的 ID 或服务器发送的 Kiss-o'-Death 代码
        /// </summary>
        /// <value>
        /// <para>
        ...
        /// 初始化默认请求包，设置 Mode 为 Client 模式，VersionNumber 为 4，TransmitTimestamp 为当前 UTC 时间
        /// </summary>
        /// <remarks>
        ...
        /// 从服务器响应数据初始化一个 NtpPacket 对象，并设置 DestinationTimestamp
        /// </summary>
