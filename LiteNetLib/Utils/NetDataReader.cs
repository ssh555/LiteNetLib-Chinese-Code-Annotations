...
namespace LiteNetLib.Utils
{
    ...
    public class NetDataReader
    {
        ...
        /// </summary>
        /// <param name="source"></param>
        /// <param name="offset">数据读取的开始位置</param>
        /// <param name="maxSize">数据长度(一般小于source.length)</param>
        ...
        #region GetMethods -> 基于当前positon指针位置获取下一个相应的数据并推进读取指针
        /// <summary>
        /// 反序列化原生数据为类型T -> 自定义非基础数据类型
        /// </summary>
        ...
        /// <summary>
        /// 使用constructor生成result再进行反序列化 -> 自定义非基础数据类型
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="result"></param>
        ...
        /// 获取数组
        /// </summary>
        /// <typeparam name="T">自定义序列化类型</typeparam>
        /// <returns></returns>
        ...
        public string GetString(int maxLength)
        {
            ...
            if (size == 0)
                return string.Empty;
            // 实际长度 -> 去除了原字符串末尾的结束字符0
            int actualSize = size - 1;
            // 设置了最大长度&&字符串长度超过了最大长度则返回空
        ...
        #region PeekMethods -> 获取当前数据，但不推进读取指针
        ...
        #region TryGetMethods -> 是否还有可剩余可读取的字节
